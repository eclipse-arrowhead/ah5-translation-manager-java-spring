...
public class TranslationBridgeValidation {
	...
	//-------------------------------------------------------------------------------------------------
	public NormalizedTranslationNegotiationRequestDTO validateAndNormalizeNegotiationRequest(final String requester, final TranslationNegotiationRequestDTO dto, final String origin) {
		logger.debug("validateAndNormalizeNegotiationRequest started...");
		Assert.isTrue(!Utilities.isEmpty(origin), "origin is empty");

		validateNegotiationRequest(dto, origin);
		final NormalizedTranslationNegotiationRequestDTO normalized = normalizeNegotiationRequest(requester, dto);
	...
	//-------------------------------------------------------------------------------------------------
	private NormalizedTranslationNegotiationRequestDTO normalizeNegotiationRequest(final String requester, final TranslationNegotiationRequestDTO dto) {
