...
public class DefaultDataModelTranslatorMatchmaker implements DataModelTranslatorMatchmaker {
	...
	public ServiceInstanceResponseDTO doMatchmaking(final List<ServiceInstanceResponseDTO> candidates, final Map<String, Object> context) {
		logger.debug("DefaultDataModelTranslatorMatchmaker.doMatchmaking started...");
