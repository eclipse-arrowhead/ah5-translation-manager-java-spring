...
public class TranslationBridgeMqttHandler extends MqttTopicHandler {
	...
	//-------------------------------------------------------------------------------------------------
	private TranslationDiscoveryResponseDTO discovery(final String requester, final TranslationDiscoveryRequestDTO reportDTO) {
		logger.debug("TranslationBridgeMqttHandler.discovery started");

		return service.discoveryOperation(requester, reportDTO, baseTopic() + Constants.SERVICE_OP_DISCOVERY);
	}
