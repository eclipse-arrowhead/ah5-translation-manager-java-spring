...
public final class TranslationManagerConstants {
	...
	public static final String MQTT_API_REPORT_BASE_TOPIC = "/report/";
	public static final String MQTT_API_BRIDGE_BASE_TOPIC = "/bridge/";
	...
	public static final String FLAG_CONSUMER_BLACKLIST_CHECK = "consumerBlacklistCheck";
	public static final String FLAG_CANDIDATES_BLACKLIST_CHECK = "candidatesBlacklistCheck";
	public static final String FLAG_TRANSLATORS_BLACKLIST_CHECK = "translatorsBlacklistCheck";
	public static final String FLAG_CANDIDATES_AUTH_CHECK = "candidatesAuthorizationCheck";
	public static final String FLAG_TRANSLATORS_AUTH_CHECK = "translatorsAuthorizationCheck";
